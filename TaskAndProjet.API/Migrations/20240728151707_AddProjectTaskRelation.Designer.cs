...
namespace TaskAndProjet.API.Migrations
{
    ...
    [Migration("20240728151707_AddProjectTaskRelation")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskAndProjet.API.Models.ProjectTaskModels", b =>
                {
            ...
            modelBuilder.Entity("TaskAndProjet.API.Models.ProjectTaskModels", b =>
                {
                    b.HasOne("TaskAndProjet.API.Models.ProjectsModels", "Project")
                        .WithMany("ProjectTasks")
                        .HasForeignKey("ProjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TaskAndProjet.API.Models.TaskModel", "Task")
                        .WithMany("ProjectTasks")
